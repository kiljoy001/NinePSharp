...
public class BitcoinFileSystem : INinePFileSystem
{
    ...
    public async Task<Rwalk> WalkAsync(Twalk twalk)
    {
        ...
        {
            var qidType = name.Length > 20 ? QidType.QTDIR : QidType.QTFILE; // Rough heuristic for address dir
            qids.Add(new Qid(qidType, 0, (ulong)name.GetHashCode()));
        }
    ...
    {
        var stat = new Stat(0, 0, 0, new Qid(QidType.QTDIR, 0, 0), 0755 | (uint)NinePConstants.FileMode9P.DMDIR, 0, 0, 0, "btc", "scott", "scott", "scott");
