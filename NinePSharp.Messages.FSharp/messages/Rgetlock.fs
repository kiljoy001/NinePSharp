...
type Rgetlock =
    ...
    interface ISerializable with
        ...
        member this.Type = MessageTypes.Rgetlock
        member this.Tag = this.Tag
        member this.WriteTo(span: Span<byte>) =
            let mutable offset = 0
            writeHeaders this.Size this.Tag MessageTypes.Rgetlock span &offset
    ...
    static member Parse (data: ReadOnlySpan<byte>) =
        ...
        { Size = size; Tag = tag; LockType = lockType; Start = start; Length = length; ProcId = procId; ClientId = clientId }
