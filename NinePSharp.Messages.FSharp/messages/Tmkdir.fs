...
type Tmkdir =
    ...
    interface ISerializable with
        ...
        member this.Type = MessageTypes.Tmkdir
        member this.Tag = this.Tag
        member this.WriteTo(span: Span<byte>) =
            let mutable offset = 0
            writeHeaders this.Size this.Tag MessageTypes.Tmkdir span &offset
    ...
    static member Parse (data: ReadOnlySpan<byte>) =
        ...
        { Size = size; Tag = tag; Dfid = dfid; Name = name; Mode = mode; Gid = gid }
